...
[Defines]
  ...
  OUTPUT_DIRECTORY                    = Build/LinuxUefiPayloadPkg
...
[LibraryClasses]
  ...
  #
  # The functions in MemoryAllocationLib are already implemented in LinuxUniversalPayloadEntry.inf. 
  # However, MemoryAllocationLib assumes there should be a seperate library provide these function
  # and need the MemoryAllocationLib specified in [LibraryClasses] section in des file.
  # In this case, the WA is to specify an empty library or a non-relevant library.
  #
  MemoryAllocationLib|MdeModulePkg/Library/LockBoxNullLib/LockBoxNullLib.inf
...
[Components.IA32]
  UefiPayloadPkg/UefiPayloadEntry/LinuxUniversalPayloadEntry.inf
