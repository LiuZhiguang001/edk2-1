...
EFI_RESOURCE_ATTRIBUTE_TYPE  OffenResourceAttribute[5];
  ...
  )
{
  ...
  UINTN   ResourcePointArrayMaxCount = 100;       // must no larger than ResourcePointArray, and is an even number
  UINTN   MemoryPointArrayMaxCount   = 100;
